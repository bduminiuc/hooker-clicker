...
class MouseEvent(object):
    ...
    def __init__(self, current_key=None, event_type=None, mouse_x=None, mouse_y=None, event_code=None):
        self.current_key = current_key
        self.event_type = event_type
            ...
            def mouse_low_level_handler(code, event_code, kb_data_ptr):
                ...
                try:
                    ...
                    if current_key != 'Move':  # if we aren't moving, then we deal with a mouse click
                        ...
                        event = MouseEvent(current_key, event_type, kb_data_ptr[0], kb_data_ptr[1], event_code)
